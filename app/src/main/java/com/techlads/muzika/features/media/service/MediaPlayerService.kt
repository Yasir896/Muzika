...
import com.techlads.muzika.features.media.exoplayer.MediaPlayerNotificationManager
import com.techlads.muzika.features.media.exoplayer.MediaSource
...
class MediaPlayerService: MediaBrowserServiceCompat() {
    ...
    override fun onCustomAction(
        ...
        when(action) {
            ...
            Constant.REFRESH_MEDIA_PLAY_ACTION -> {
                mediaSource.refresh()
